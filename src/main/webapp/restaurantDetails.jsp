               ...
               <div class="single-post">
                  ...
                  <div class="blog_details">
                     ...
                     <div class="blog-author">
                        ...
                        <div class="c" style="font:16px;"><strong>식당 위치</strong></div>
                        <div id="map"></div>
                        ...
                        <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a32b57a475f435fc309a9fd6a26c2d42&libraries=services"></script>
                     </div>
                     ...
                     <c:when test="${ memberid != null }">
                        ...
                        <c:if test="${ynrevVO!=null}">
                           ...
                           <form method="post" action="revupdate.do">
                              ...
                              <input type="hidden" id="starRating" name="revScore" value="5" />
                              <div class="row">
                                 <div class="col-12">
                                    
                                    <div class="form-group">
                                       <textarea class="form-control w-100" id="comment" cols="30"
                                          rows="9" placeholder="${ynrevVO.revCont}"
                                          name="revCont" required></textarea>
                                    </div>
                                 </div>
                              </div>
                              <br>
